...
const HasanPortfolio = () => {
  ...
  return (
    <div className="w-screen h-screen bg-black text-white font-mono p-4 flex flex-col overflow-hidden">
      <div className="flex-grow overflow-auto mb-4 scrollbar-hide">
      ...
      <div className="flex items-center">
        ...
        <input
          ...
          className="bg-transparent focus:outline-none flex-grow min-w-0"
          autoFocus
        />
      </div>
    </div>
